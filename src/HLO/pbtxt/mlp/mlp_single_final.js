...
ENTRY %SyncTensorsGraph.316 (p0.1: f32[], p1.6: f32[120], p2.14: f32[120,784], p3.23: f32[32,784], p4.33: f32[84,120], p5.43: f32[84], p6.61: f32[10,84], p7.71: f32[10], p8.104: s64[32]) -> (f32[120,784], f32[120], f32[84,120], f32[84], f32[10,84], /*index=5*/f32[10], f32[32,784], s64[32], f32[32,10], f32[]) {
  ...
  %p3.23 = f32[32,784]{1,0} parameter(3), frontend_attributes={neff_input_names="input3"}, metadata={op_type="xla__device_data" op_name="xla__device_data" source_file="train.py" source_line=68}
  ...
  %p8.104 = s64[32]{0} parameter(8), frontend_attributes={neff_input_names="input8"}, metadata={op_type="xla__device_data" op_name="xla__device_data" source_file="train.py" source_line=69}
  ...
  ROOT %tuple.315 = (f32[120,784]{1,0}, f32[120]{0}, f32[84,120]{1,0}, f32[84]{0}, f32[10,84]{1,0}, /*index=5*/f32[10]{0}, f32[32,784]{1,0}, s64[32]{0}, f32[32,10]{1,0}, f32[]) tuple(f32[120,784]{1,0} %add.177, f32[120]{0} %add.199, f32[84,120]{1,0} %add.215, f32[84]{0} %add.237, f32[10,84]{1,0} %add.253, /*index=5*/f32[10]{0} %add.275, f32[32,784]{1,0} %p3.23, s64[32]{0} %p8.104, f32[32,10]{1,0} %subtract.103, f32[] %divide.314), frontend_attributes={neff_output_names="output0,output1,output2,output3,output4,output5,output6,output7,output8,output9"}
}
