...
ENTRY %SyncTensorsGraph.357 (p0.1: f32[], p1.6: f32[], p2.7: f32[120], p3.15: f32[120,784], p4.24: f32[32,1,28,28], p5.35: f32[84,120], p6.45: f32[84], p7.63: f32[10,84], p8.73: f32[10], p9.106: s64[32]) -> (f32[120,784], f32[120], f32[84,120], f32[84], f32[10,84], /*index=5*/f32[10], f32[32,784], f32[32,10], f32[]) {
  ...
  %p4.24 = f32[32,1,28,28]{3,2,1,0} parameter(4), frontend_attributes={neff_input_names="input4"}, metadata={op_type="xla__device_data" op_name="xla__device_data" source_file="train_torchrun.py" source_line=89}
  ...
  ROOT %tuple.356 = (f32[120,784]{1,0}, f32[120]{0}, f32[84,120]{1,0}, f32[84]{0}, f32[10,84]{1,0}, /*index=5*/f32[10]{0}, f32[32,784]{1,0}, f32[32,10]{1,0}, f32[]) tuple(f32[120,784]{1,0} %add.286, f32[120]{0} %add.292, f32[84,120]{1,0} %add.298, f32[84]{0} %add.304, f32[10,84]{1,0} %add.310, /*index=5*/f32[10]{0} %add.316, f32[32,784]{1,0} %reshape.25, f32[32,10]{1,0} %subtract.105, f32[] %divide.355), frontend_attributes={neff_output_names="output0,output1,output2,output3,output4,output5,output6,output7,output8"}
}
