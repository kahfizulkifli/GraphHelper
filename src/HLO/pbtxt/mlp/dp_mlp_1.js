...
ENTRY %SyncTensorsGraph.357 (p0.1: f32[], p1.6: f32[], p2.7: f32[120], p3.15: f32[120,784], p4.24: f32[16,1,28,28], p5.35: f32[84,120], p6.45: f32[84], p7.63: f32[10,84], p8.73: f32[10], p9.106: s64[16]) -> (f32[120,784], f32[120], f32[84,120], f32[84], f32[10,84], /*index=5*/f32[10], f32[16,784], f32[16,10], f32[], f32[10], /*index=10*/f32[10,84], f32[84], f32[84,120], f32[120], f32[120,784]) {
  ...
  %p4.24 = f32[16,1,28,28]{3,2,1,0} parameter(4), frontend_attributes={neff_input_names="input4"}, metadata={op_type="xla__device_data" op_name="xla__device_data" source_file="train_torchrun.py" source_line=66}
