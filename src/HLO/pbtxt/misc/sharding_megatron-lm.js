...
ENTRY %SyncTensorsGraph.75_spmd (param.6: f32[1], param.5: f32[1,1], param.4: f32[1], param.3: f32[1,3], param.2: f32[5], param.1: f32[3,10], param: f32[10,10]) -> (f32[10,1]) {
  ...
  %param.3 = f32[1,3]{1,0} parameter(3), sharding={devices=[1,2]0,1}, frontend_attributes={neff_input_names="input3"}, metadata={op_type="xla__device_data" op_name="xla__device_data" source_file="/home/ubuntu/kahfi/xla_modified/pytorch/xla/torch_xla/core/xla_op_registry.py" source_line=44}
  %all-gather.1 = f32[1,6]{1,0} all-gather(f32[1,3]{1,0} %param.3), channel_id=2, replica_groups={{0,1}}, dimensions={1}, use_global_device_ids=true, metadata={op_type="xla___op_TransferWithStaticRingTransfer" op_name="xla___op_TransferWithStaticRingTransfer" source_file="/home/ubuntu/kahfi/xla_modified/pytorch/xla/torch_xla/core/xla_op_registry.py" source_line=44}
  %slice.1 = f32[1,5]{1,0} slice(f32[1,6]{1,0} %all-gather.1), slice={[0:1], [0:5]}, metadata={op_type="xla___op_TransferWithStaticRingTransfer" op_name="xla___op_TransferWithStaticRingTransfer" source_file="/home/ubuntu/kahfi/xla_modified/pytorch/xla/torch_xla/core/xla_op_registry.py" source_line=44}
  %custom-call.16 = f32[1,5]{1,0} custom-call(f32[1,5]{1,0} %slice.1), custom_call_target="AwsNeuronTransferWithStaticRing", api_version=API_VERSION_UNSPECIFIED, metadata={op_type="xla___op_TransferWithStaticRingTransfer" op_name="xla___op_TransferWithStaticRingTransfer" source_file="/home/ubuntu/kahfi/xla_modified/pytorch/xla/torch_xla/core/xla_op_registry.py" source_line=44}
